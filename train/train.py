...
def model_fn(model_dir):
    ...
    Returns:
        model (LSTMClassifier): RNN model constructed using parameters 
...
def train(model, train_loader, epochs, optimizer, loss_fn, device):
    ...
    Args:
        model (LSTMClassifier): the PyTorch model to be trained
        train_loader (DataLoader): the PyTorch DataLoader to be used 
            during training
